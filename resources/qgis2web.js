...
map.getView().fit([8530713.498264, 1038646.603349, 8538933.344839, 1043746.062276], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ARANMULA - ANGANAWADI</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (332 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Aranmula, located in Pathanamthitta district, has several Anganwadi centres functioning under the Integrated Child Development Services (ICDS) scheme of the Government of India. These centres are grassroots-level institutions aimed at improving child health, nutrition, and early education, especially in rural and semi-urban areas.';
            }
